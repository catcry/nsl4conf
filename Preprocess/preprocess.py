...
def prep_manual(faddr,seperator,vald,vald_percentage,test,test_percentage,\
 ...
 #========================>   Normalization   <=============================
    ...
    if hard_test == 1:           
        ...
        R=np.append(Xtest,Ytest,axis=1)
        R = R[R[:,41]<hard_test_level]
        Xhard = R[:,0:41]
        Yhard = R[:,42].astype(int)
    ...
    return Xtrain,Ytrain,Xvalid,Yvalid,Xtest,Ytest,Xhard,Yhard
